...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    // og:image is generated by app/opengraph-image.tsx (and per-section
    // opengraph-image.tsx files) so each section gets its own branded card.
  },
  twitter: {
  ...
  return (
    <html lang="en">
      <head>
        <script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7919679791683906"
